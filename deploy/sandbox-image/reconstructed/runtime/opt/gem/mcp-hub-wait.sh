...
WAIT_MCP_SERVERS_PORTS=${MCP_HUB_WAIT_PORTS:-$MCP_SERVER_BROWSER_PORT,$SANDBOX_SRV_PORT}
...
exec /usr/bin/mcp-hub --port $DEFAULT_PORT --stateless --config /opt/gem/mcp-hub.json
