...
- **Cold snapshot / start-from-cold restore design:** [docs/zh-CN/modules/09-cold-snapshot-restore.md](zh-CN/modules/09-cold-snapshot-restore.md) — persistent sandbox cold storage, start-triggered restore orchestration, and current ACK-first boundaries.
