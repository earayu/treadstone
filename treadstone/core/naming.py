...
_ADJECTIVES: tuple[str, ...] = (
    "brave","calm","clever","crisp","daring","eager","fuzzy","gentle","glossy","humble",
    "icy","jolly","keen","lively","merry","neat","nimble","proud","quick","quiet",
    "rapid","shiny","silent","smart","snug","solid","spry","sturdy","sunny","swift",
    "tidy","tiny","vivid","warm","witty","zesty","bold","bright","chill","clean",
)

_NOUNS: tuple[str, ...] = (
    "acorn","amber","anchor","aster","badge","beacon","birch","breeze","canyon","cedar",
    "comet","coral","cotton","crane","ember","falcon","feather","flint","harbor","heron",
    "horizon","iron","ivy","juniper","lagoon","larch","mesa","minnow","nebula","oak",
    "onyx","otter","pebble","pine","quartz","reef","river","spruce","tundra","willow",
)
