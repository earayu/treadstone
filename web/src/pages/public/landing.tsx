...
const PLANS = [
  {
    ...
    features: [
      ...
      "Default auto-stop: 1\u00a0hr",
      "Configurable up to 2\u00a0hr",
  ...
  },
  {
    ...
    badge: "EARLY ACCESS",
    badgeSoon: false,
    desc: "Built for steady agent workloads, persistent workspaces, and small multi-agent systems. We review each account and enable the matching envelope.",
    features: [
      "180\u00a0CU-h compute / month",
      "5 concurrent sandboxes",
      "All templates up to aio-sandbox-medium",
      "20\u00a0GiB persistent storage quota",
      "Default auto-stop: 1\u00a0hr",
      "Never auto-stop allowed",
  ...
  },
  {
    ...
    badge: "EARLY ACCESS",
    badgeSoon: false,
    desc: "For heavier personal dev hosts and real multi-agent orchestration. Tell us what you are building and we will size the account to fit.",
    features: [
      "480\u00a0CU-h compute / month",
      "15 concurrent sandboxes",
      "All templates up to aio-sandbox-medium",
      "60\u00a0GiB persistent storage quota",
      "Default auto-stop: 1\u00a0hr",
      "Never auto-stop allowed",
  ...
  },
  {
    ...
    features: [
      "1800\u00a0CU-h compute / month (typical envelope)",
      "50 concurrent sandboxes",
      "200\u00a0GiB persistent storage quota",
      "Default auto-stop: 1\u00a0hr",
      "Never auto-stop allowed",
      "24\u00a0hr grace period",
