...
T = TypeVar("T", bound="CreateComputeGrantRequest")


@_attrs_define
class CreateComputeGrantRequest:
    """
    Attributes:
        amount (float):
        grant_type (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_compute_grant_request = cls(
            amount=amount,
            grant_type=grant_type,
            reason=reason,
        ...
        create_compute_grant_request.additional_properties = d
        return create_compute_grant_request
