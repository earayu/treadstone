...
T = TypeVar("T", bound="CreateStorageQuotaGrantResponse")


@_attrs_define
class CreateStorageQuotaGrantResponse:
    """
    Attributes:
        id (str):
        user_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_storage_quota_grant_response = cls(
            id=id,
            user_id=user_id,
            size_gib=size_gib,
            grant_type=grant_type,
        ...
        create_storage_quota_grant_response.additional_properties = d
        return create_storage_quota_grant_response
