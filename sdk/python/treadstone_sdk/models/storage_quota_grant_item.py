...
T = TypeVar("T", bound="StorageQuotaGrantItem")


@_attrs_define
class StorageQuotaGrantItem:
    """
    Attributes:
        id (str):
        grant_type (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        storage_quota_grant_item.additional_properties = d
        return storage_quota_grant_item
