...
T = TypeVar("T", bound="BatchStorageQuotaGrantRequest")


@_attrs_define
class BatchStorageQuotaGrantRequest:
    """
    Attributes:
        user_ids (list[str]):
        size_gib (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_storage_quota_grant_request = cls(
            user_ids=user_ids,
            size_gib=size_gib,
            grant_type=grant_type,
        ...
        batch_storage_quota_grant_request.additional_properties = d
        return batch_storage_quota_grant_request
